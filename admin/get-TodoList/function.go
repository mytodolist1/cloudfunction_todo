...
func init() {
	functions.HTTP("MytodolistGetTodoList", MytodolistGetTodoList)
}

func MytodolistGetTodoList(w http.ResponseWriter, r *http.Request) {
	...
	// w.Header().Set("Access-Control-Allow-Origin", "https://mytodolist.my.id")
	fmt.Fprintf(w, todo.GCFHandlerGetAllTodoList("PASETOPUBLICKEY", "MONGOSTRING", "mytodolist", "todo", r))
}
